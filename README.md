...
<p>
  ...
  <img src="https://img.shields.io/badge/Image-5.2.3--r1-2496ED?style=for-the-badge&logo=docker&logoColor=white" alt="Image Tag"/>
...
Current stack pin: **Moodle 5.2.3** · image **`abstechnology/moodle-standard:5.2.3-r1`** · **PHP 8.4** · compose MariaDB **11.8.9**. Version source of truth: [`versions.lock`](https://github.com/abs-technology/moodle/blob/main/versions.lock).
...
- 🚀 **Moodle 5.2.3** - Current stable pin (`5.2.3-r1` image)
...
* [`5.2.3-r1`, `5.2.3`, `5.2`, `latest`](https://github.com/abs-technology/moodle/blob/main/Dockerfile)

Pinned in [`versions.lock`](https://github.com/abs-technology/moodle/blob/main/versions.lock): Moodle **5.2.3** from [packaging.moodle.org stable502](https://packaging.moodle.org/stable502/moodle-5.2.3.tgz), PHP **8.4**, Docker tag **`5.2.3-r1`**.
...
```console
$ docker pull abstechnology/moodle-standard:5.2.3-r1
```
...
$ docker run -d --name moodle \
  ...
  abstechnology/moodle-standard:5.2.3-r1
```
...
- `MOODLE_USERNAME`: Moodle admin username. Always **admin** at first install; later restarts do not rename it.
...
services:
  ...
  moodle:
    image: abstechnology/moodle-standard:5.2.3-r1
...
| 📦 **Image tag** | `5.2.3-r1` | Marketplace-oriented pin (see `versions.lock`) |
