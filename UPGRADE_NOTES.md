...
```bash
docker build -t moodle-core:5.0.3-plus .
```
...
# Use previous image
docker-compose down
docker tag moodle-core:5.0.3-plus moodle-core:5.0.3-plus-new
docker tag moodle-core:5.0.3-plus-old moodle-core:5.0.3-plus
docker-compose up -d
```
